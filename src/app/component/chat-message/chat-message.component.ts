...
export class ChatMessageComponent implements OnInit {
  ...
  get hasRoundNote(): boolean {
    return 0 < Number(this.chatMessage.round);
  }

  get displayText(): string {
    return RoomState.instance.isGM() && this.chatMessage.gmText ? this.chatMessage.gmText : this.chatMessage.text;
  }
